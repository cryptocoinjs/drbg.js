...
tap.test('HashDRBG', function (t) {
  t.test('not supported hash algorithm', function (t) {
    t.throws(function () {
      new HashDRBG('md5')  // eslint-disable-line no-new
  ...
  t.test('not enough entropy', function (t) {
    t.test('on initialization', function (t) {
      t.throws(function () {
        new HashDRBG('sha256', new Buffer(0), new Buffer(32))  // eslint-disable-line no-new
      }, new Error('Not enough entropy'))
      t.end()
    })

    t.test('on reseed', function (t) {
      var drbg = new HashDRBG('sha256', new Buffer(32), new Buffer(32))
      t.throws(function () {
  ...
  t.test('NIST vector', function (t) {
    function test (algo, algoVectors) {
      var vectors = NISTVectors.get('hash', algoVectors)
      t.test(algo, function (t) {
        vectors.forEach(function (vector) {
          var drbg = new HashDRBG(algo, vector.EntropyInput, vector.Nonce, vector.PersonalizationString)
